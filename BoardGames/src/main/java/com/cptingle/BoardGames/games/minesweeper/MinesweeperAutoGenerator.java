...
public class MinesweeperAutoGenerator {
	public static boolean autogenerate(Location loc, int radius, String name, BoardGames plugin) {
		...
		int bx1 = (int) loc.getX() - radius + 4;
		int bx2 = (int) loc.getX() + radius - 4;
		...
		region.set("board-point-1", new Location(world, bx1, by, bz1));
		region.set("board-point-2", new Location(world, bx2, by, bz2));
